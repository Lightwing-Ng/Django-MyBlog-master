 ...
 * created on Mar 28, 2018, 12:22 AM
 * Software: PyCharm
...
class WhooshSearchBackend(BaseSearchBackend):
        ...
        for field_name, field_class in fields.items():
            if field_class.is_multivalued:
                ...
                schema_fields[field_class.index_fieldname] = NGRAM(
                    minsize=3, maxsize=15, stored=field_class.stored,
                    field_boost=field_class.boost
                )
    ...
    @log_query
    def search(
            self, query_string, sort_by=None, start_offset=0, end_offset=None,
    ...
    def more_like_this(
            self, model_instance, additional_query_string=None,
